...
from utils import load_train_data, mkdir, imread, save_images, load_train_data_image, convert_image_cv2
...
class MagNet3FramesLive(object):
    ...
    def inference_live(self, frameA, frameB, amplification_factor):
        """Run Magnification on two frames.
